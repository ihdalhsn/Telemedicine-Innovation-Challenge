...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
	...
	<head>
		...
		<title> <?php echo $page_title != "" ? $page_title." - " : ""; ?>Telemedicine </title>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo ASSETS_URL; ?>/css/ecg.css">
		...
		<!-- FAVICONS -->
		<link rel="shortcut icon" href="<?php echo ASSETS_URL; ?>/img/favicon/favicontic.png" type="image/x-icon">
		<link rel="icon" href="<?php echo ASSETS_URL; ?>/img/favicon/favicontic.png" type="image/x-icon">
				...
				<header id="header">
					...
					<div class="pull-right">
						...
						<div id="logout" class="btn-header transparent pull-right">
							<span> <a href="<?php echo APP_URL; ?>/logout.php" title="Sign Out" data-action="userLogout" data-logout-msg=" "><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->

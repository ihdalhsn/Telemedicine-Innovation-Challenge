		...
		<script src="<?php //echo ASSETS_URL; ?>/js/ecg/gambar.js"></script>
		<script src="<?php //echo ASSETS_URL; ?>/js/ecg/ecg.js"></script>
		 <script src="<?php// echo ASSETS_URL; ?>/js/ecg/ukuran.js"></script>-->
